...
#FASTA format is incompatible with BioPython tree generation software so convert the aligned sequence output to phylip format
from Bio import AlignIO
...
alignments = AlignIO.parse(output_fas, "fasta") #read in the fasta output using parse
